...
class Virglrenderer < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 arm64_tahoe: "783e3dad6e0761b19ea72fcda04f3ba0dcba3e09330e34b1ae680bfb3e79a4dd"
  end
  ...
  def install
    ...
    # it. Manually clone venus-protocol v1.1.3 into the subprojects dir so
    ...
    # `directory` field (venus-protocol-1.1.3 at our pinned rev). v1.1.2+ ships
    # include/vulkan/vulkan_metal.h, which src/venus/vkr_metal_helpers.m
    # includes via "venus-protocol/vulkan_metal.h".
    venus_dir = buildpath/"subprojects/venus-protocol-1.1.3"
    unless venus_dir.exist?
      system "git", "clone", "--depth=1", "--branch=v1.1.3",
