...
The codebase encodes a lot of opinions about specific Homebrew formula
...
For any **security-sensitive** issue (e.g., the generated Homebrew formula
leaking secrets, or enabling unsafe defaults), please contact the
repository owner directly via GitHub rather than opening a public
issue or PR.
